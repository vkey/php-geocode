...
class Location
{
    ...
    /**
     * @var string Street formatted address
     */
    ...
    private function populateDetail(\stdClass $locationDetail)
    {
        ...
        $this->formattedAddress = $locationDetail->results[0]->formatted_address;
     ...
     * @return string
     */
    public function getFormattedAddress($default = '')
    {
        return $this->formattedAddress ?: $default;
    }
